...
CATEGORIES = {
    ...
    "IRONBAR": {".config/ironbar/config.yaml", ".config/ironbar/style.css"},
    ...
    "ROFI": {".config/rofi/theme.rasi", ".config/rofi/config.rasi"},
    "ALACRITTY": {".config/alacritty/alacritty.toml"},
    "DUNST": {".config/dunst/dunstrc"},
    "SPOTIFY": {".config/spotifyd/spotifyd.conf"},
    "SWAYNC": {".config/swaync/config.json", ".config/swaync/style.css"},
    "I3STATUS": {".config/i3status/config", ".config/i3status/config-small"},
    "ANYRUN": {
